...
const Homescreen= ({navigation})=>{
  ...
  <View>
    ...
    style={styles.header}
    >
      <Icon name="home" color={"#DBF9DB"} size={43}  marginLeft={10} marginTop={40} />
    <Text style={{
      color:"#DBF9DB",
      fontSize:30,
      marginTop:10,
  ...
  onPress={()=>navigation.navigate("Your Club")} 

      name="pin-drop" size={50} color="#022658" backgroundColor={"#DBF9DB"}></Icon.Button>
    <Text style={{color:"black",fontWeight:"bold",fontSize:16}}>Your Club</Text>
    </View>
    <View style={styles.bt5}>
  <Icon.Button
  
  onPress={()=>navigation.navigate("Create Portfolio")} 

      name="edit" size={50} color="#022658" backgroundColor={"#DBF9DB"}></Icon.Button>
    <Text style={{color:"black",fontWeight:"bold",fontSize:16}}>Create Portfolio</Text>
    </View>
  ...
  onPress={()=>navigation.navigate("FAQs")} 
      ...
      name="sms" size={50} color="#022658"  marginLeft={5} backgroundColor={"#D2FFD2"}></Icon.Button>
  ...
  onPress={()=>navigation.navigate("Profile")} 
      ...
      name="account-circle" size={55} color="#022658"  backgroundColor={"#DBF9DB"}></Icon.Button>
  ...
  onPress={()=>navigation.navigate("Terms and Conditions")} 
    ...
    onPress={()=>navigation.navigate("purchase Screen")} 
        ...
        name="shopping-cart" size={50} color="#022658" backgroundColor={"#DBF9DB"} ></Icon.Button>
